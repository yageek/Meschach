...
MACRO (CHECK_HEADER_STDC)
  IF(NOT DEFINED STDC_HEADERS)
    ...
    TRY_RUN(CHECK_HEADER_STDC_result
      ...
      ${CMAKE_BINARY_DIR}
      ${CMAKE_CURRENT_SOURCE_DIR}/cmake_modules/CheckHeaderSTDC.c
    ...
    IF(CHECK_HEADER_STDC_result)
      MESSAGE(STATUS "Checking for ANSI C header files - found")
    ...
    ELSE(CHECK_HEADER_STDC_result)
      MESSAGE(STATUS "Checking for ANSI C header files - not found")
